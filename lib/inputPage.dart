    ...
    return Scaffold(
      body: ListView
        ...
        Column(children: <Widget>[
          TextField(
              decoration: InputDecoration(
                border: InputBorder.none, hintText: 'รายการสินค้า',)
          ),
          TextFormField(
        ...
        Column(children: <Widget>[
          ...
          TextFormField(
            decoration: InputDecoration(labelText: 'ลิงค์/ที่อยู่รูปร้านค้า'),
          ),
          FlatButton(
              color: Colors.red[300],
              child: Text("อัพโหลดรูป", style: TextStyle(color: Colors.black))),
        ],),
        FlatButton(
            color: Colors.red[300],
