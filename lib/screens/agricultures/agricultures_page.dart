...
class AgriculturesPage extends StatefulWidget {
  AgriculturesPage({
    Key key,
  }) : super(key: key);

  _AgriculturesPageState createState() => _AgriculturesPageState();
}

class _AgriculturesPageState extends State<AgriculturesPage> {
